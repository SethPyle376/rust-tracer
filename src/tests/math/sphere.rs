...
pub fn sphere_intersection_test() {
    let mut sphere1 = Sphere::new(Mat4::identity(), 0, Material::default_material());
...
pub fn sphere_nearest_intersection_test() {
    let sphere1 = Sphere::new(Mat4::identity(), 0, Material::default_material());
...
pub fn sphere_transformed_normal_at_test() {
    ...
    let sphere = Sphere::new(transformation_matrix, 0, Material::default_material());
